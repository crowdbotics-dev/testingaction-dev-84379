"""
Django settings for testingaction_dev_84379 project.
...
ROOT_URLCONF = 'testingaction_dev_84379.urls'
...
WSGI_APPLICATION = 'testingaction_dev_84379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testingaction_dev_84379 API",
    "DESCRIPTION": "API documentation for testingaction_dev_84379 App",
    "VERSION": "v1",
}
